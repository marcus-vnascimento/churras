...
// Set session variables to be used on new-account.php page
    if ($_POST['email'] == '' || $_POST['pwd'] == '' || $_POST['pwd2'] == '' || $_POST['email'] == NULL || $_POST['pwd'] == NULL || $_POST['pwd2'] == NULL ) {
        ...
        if ($_POST['pwd'] == $_POST['pwd2']) {
            ...
            $result = $mysqli->query("SELECT email FROM accounts WHERE email='$email'") or die($mysqli->error);
